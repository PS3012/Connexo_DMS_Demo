          ...
          <div className="document-block">
            ...
            {form === "Audit Program" ? (
              <div className="document-form">
                ...
                <div className="form-flex">
                  <div className="group-input">
                    <label htmlFor="related_url">Related URl's</label>
                    <input type="url" name="related_url" id="related_url" />
                  </div>

                  <div className="col-lg-6">
                    <div className="group-input">
                      <label htmlFor="related_url">URl's description</label>
                      <input
                        type="text"
                ...
                <div className="col-12">
                  <div className="group-input">
                    <label htmlFor="suggested_audit">Suggested Audits</label>
                    <input type="text" name="suggested_audits" />
                  </div>
                </div>

                <div className="col-12">
                  <div className="sub-head">Geographical Information</div>
                </div>
                ...
                <div className="form-flex">
                  ...
                  <div className="col-lg-6">
                    <div className="group-input">
                      ...
                      >
                        ...
                        <option value="American Samoa" countryid="5">
                          American Samoa
                        </option>
                        ...
                        <option value="Bosnia and Herzegovina" countryid="28">
                          Bosnia and Herzegovina
                        </option>
                        <option value="Botswana" countryid="29">
                          Botswana
                        </option>
                        <option value="Bouvet Island" countryid="30">
                          Bouvet Island
                        </option>
                        ...
                        <option value="Cayman Islands" countryid="41">
                          Cayman Islands
                        </option>
                        <option value="Central African Republic" countryid="42">
                        ...
                        <option value="Christmas Island" countryid="46">
                          Christmas Island
                        </option>
                        <option value="Cocos (Keeling) Islands" countryid="47">
                        ...
                        <option value="Czech Republic" countryid="58">
                          Czech Republic
                        </option>
                        ...
                        <option value="Dominican Republic" countryid="62">
                          Dominican Republic
                        </option>
                        ...
                        <option value="Equatorial Guinea" countryid="67">
                          Equatorial Guinea
                        </option>
                        ...
                        <option value="Falkland Islands" countryid="71">
                          Falkland Islands
                        </option>
                        <option value="Faroe Islands" countryid="72">
                          Faroe Islands
                        </option>
                        ...
                        <option value="French Guiana" countryid="76">
                          French Guiana
                        </option>
                        <option value="French Polynesia" countryid="77">
                          French Polynesia
                        </option>
                        <option
                        ...
                        <option value="Guernsey and Alderney" countryid="91">
                          Guernsey and Alderney
                        </option>
                        <option value="Guinea" countryid="92">
                          Guinea
                        </option>
                        <option value="Guinea-Bissau" countryid="93">
                          Guinea-Bissau
                        </option>
                        ...
                        <option value="Hong Kong S.A.R." countryid="98">
                          Hong Kong S.A.R.
                        </option>
                        ...
                        <option value="Liechtenstein" countryid="125">
                          Liechtenstein
                        </option>
                        ...
                        <option value="Macau S.A.R." countryid="128">
                          Macau S.A.R.
                        </option>
                        ...
                        <option value="Man (Isle of)" countryid="136">
                          Man (Isle of)
                        </option>
                        <option value="Marshall Islands" countryid="137">
                          Marshall Islands
                        </option>
                        ...
                        <option value="New Caledonia" countryid="157">
                          New Caledonia
                        </option>
                        ...
                        <option value="Norfolk Island" countryid="163">
                          Norfolk Island
                        </option>
                        <option
                        ...
                        <option value="Papua new Guinea" countryid="171">
                          Papua new Guinea
                        </option>
                        ...
                        <option value="Pitcairn Island" countryid="175">
                          Pitcairn Island
                        </option>
                        ...
                        <option value="Saint Helena" countryid="184">
                          Saint Helena
                        </option>
                        <option value="Saint Kitts And Nevis" countryid="185">
                        ...
                        <option value="Saint-Barthelemy" countryid="189">
                          Saint-Barthelemy
                        </option>
                        <option
                        ...
                        <option value="Sao Tome and Principe" countryid="193">
                          Sao Tome and Principe
                        </option>
                        <option value="Saudi Arabia" countryid="194">
                          Saudi Arabia
                        </option>
                        ...
                        <option value="Sierra Leone" countryid="198">
                          Sierra Leone
                        </option>
                        ...
                        <option value="Solomon Islands" countryid="202">
                          Solomon Islands
                        </option>
                        <option value="Somalia" countryid="203">
                          Somalia
                        </option>
                        <option value="South Africa" countryid="204">
                          South Africa
                        </option>
                        <option value="South Georgia" countryid="205">
                          South Georgia
                        </option>
                        ...
                        <option value="Trinidad And Tobago" countryid="223">
                          Trinidad And Tobago
                        </option>
                        ...
                        <option value="Turkmenistan" countryid="226">
                          Turkmenistan
                        </option>
                        <option
                        ...
                        <option value="United Arab Emirates" countryid="231">
                          United Arab Emirates
                        </option>
                        <option value="United Kingdom" countryid="232">
                          United Kingdom
                        </option>
                        <option value="United States" countryid="233">
                          United States
                        </option>
                        <option
                        ...
                        <option value="Virgin Islands (US)" countryid="242">
                          Virgin Islands (US)
                        </option>
                        <option
                        ...
                        <option value="Western Sahara" countryid="244">
                          Western Sahara
                        </option>
                  ...
                  <div className="col-lg-6">
                    <div className="group-input">
                      <label htmlFor="State/District">State/District</label>
                ...
                <div className="col-12 sub-head">Extension Justification</div>
