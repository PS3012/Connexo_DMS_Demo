...
function AuditProgram() {
  ...
  const body = {
    "auditProgram": {
      ...
      "auditGeneralInfo": [
        {
          "state": auditProgram.state,
          "type": auditProgram.type,
          "country": auditProgram.country,
          "zone": auditProgram.zone,
          "years": auditProgram.year,
          "dueDate": auditProgram.dueDate,
          "description": auditProgram.description,
          "shortDescription": auditProgram.shortDescription,
          "recordNumber": auditProgram.recordNumber,
          "initiator": auditProgram.initiator,
          "assignedTo": auditProgram.assignedTo,
          "initiatorGroup": auditProgram.initiatorGroup,
          "initiatorGroupCode": '',
          "initiatedThrough": auditProgram.initiatedThrough,
          "others": auditProgram.initiatedThroughOthers,
          "divisionCode": auditProgram.site,
          "dueDateExtensionJustification": auditProgram.dueDateExtensionJustification,
          "dateOfInitiation": auditProgram.dateOfInitiation,
          "quarter": auditProgram.quarter,
          "comments": auditProgram.comments,
          "relatedUrl": auditProgram.relatedUrl,
          "urlDescription": auditProgram.urlDescription,
          "suggestedAudits": auditProgram.suggestedAudit,
          "city": auditProgram.city,
          "sevrityLevel": auditProgram.severityLevel,
          "auditInfoAttach": [{
  ...
  const handleSubmit = () => {
    if (!auditProgram.dueDate) {
      toast.error("Due Date is required.")
    } else if (!auditProgram.shortDescription) {
        ...
        <div id="config-form-document-page">
          ...
          <div id="config-form-document-page">
            <div className="top-block">
              ...
              <div>
                <strong> Site:&nbsp;</strong>{auditProgram.site}
              </div>
              <div>
                <strong> Current Status:&nbsp;</strong>Under Initiation
              </div>
              <div>
                <strong> Initiated By:&nbsp;</strong>{auditProgram.initiator}
              </div>
            </div>
