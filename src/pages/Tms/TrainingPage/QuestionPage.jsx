                ...
                <div className='training-items'>
                    <div className='training-search-grid'>
                        ...
                        <div className="group-input-2">
                            ...
                            <select>
                                <option value="all_records">Question</option>
                                <option value="1">Single Selection Questions</option>
                                <option value="2">Multi Selection Questions</option>
                                <option value="3">Exact Match Questions</option>
